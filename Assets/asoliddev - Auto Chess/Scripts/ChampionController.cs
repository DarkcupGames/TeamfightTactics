...
public class ChampionController : MonoBehaviour
{
    ...
    [HideInInspector] public int teamID = 0; ///Team of this champion, can be player = 0, or enemy = 1
    [HideInInspector] public Champion champion;
    [HideInInspector] public float maxHealth = 0; ///Maximum health of the champion
    [HideInInspector] public float currentHealth = 0;    ///current health of the champion 
    [HideInInspector] public float currentDamage = 0; ///Current damage of the champion deals with a attack
    [HideInInspector] public int lvl = 1; ///The upgrade level of the champion
